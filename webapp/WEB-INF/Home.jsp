                    ...
                    <div class="inner-all">
                        <ul class="list-unstyled ">
                            <li class="text-center">
                                <img class="img-circle img-responsive img-bordered-primary" src="images/developer.jpg" alt="Marint month">
                            </li>
                            <li class="text-center">
            ...
            <div class="panel cover rounded shadow no-overflow">
                <div class="panel-body">
                  <div class="media g-mb-30 media-comment">
			            <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" src="images/profile.jpg" alt="Image Description">
