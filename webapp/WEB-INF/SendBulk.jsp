...
<!-- /.modal compose message -->
        <div class="modal-content">
          ...
          <div class="modal-body">
            <se:form action="/sendbulkemail" method="post" role="form" class="form-horizontal" modelAttribute="sendEmail">
          	...
          	<div class="modal-footer">
          		<se:input path="user" type="hidden" class="form-control" id="inputTo" value="${id_user}"/>
           	 	...
           	 	<button class="btn btn-primary ">Send <i class="fa fa-arrow-circle-right fa-lg"></i></button>
            	<a href="/home" type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</a> 
         	 </div>
            </se:form>
          </div>
        </div><!-- /.modal-content -->
