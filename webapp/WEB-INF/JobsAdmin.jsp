...
<div class="row">
    <div class="col-xl-12">
    	<div class="text-center mt-2 col-md-3">
			<a href="/jobspost">
		   		<button class="btn" style="height:50px;">
        ...
        <div class="media g-mb-30 media-comment">
            <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" src="images/developer.jpg" alt="Image Description">
